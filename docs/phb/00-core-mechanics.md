...
For the canonical definitions of status effects and recurring combat conditions such as **Grappled**, **Frightened**, **Pinned**, and **Suppressed**, see [Chapter 12: Glossary, Section 12.4](./12-glossary.md). If another chapter summarizes an effect differently, the glossary wording governs unless a specific ability adds an extra rider.
