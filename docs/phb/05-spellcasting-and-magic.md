...
#### Glyph Spells
- **Glyph of Anchoring** [GW, SR, WB]: Cost: 1 SE. Touch; lasts until triggered or until your next long rest. Choose a 5-ft square adjacent to the inscribed surface. The first creature that attempts to teleport or shift realms (see [Chapter 11, Section 11.1](./11-realms-terrain-arcane-power.md#111-realm-affinity)) into, out of, or through that square triggers the glyph and must succeed on a DR 2 Will save or the teleport/shift fails and the action, spell, or effect is wasted.
...
- **Phase Snare** [SR, HW]: Cost: 2 SE. 30 ft; DR 3 Soul save or take 2 Spectral damage and be unable to teleport, shift realms (see [Chapter 11, Section 11.1](./11-realms-terrain-arcane-power.md#111-realm-affinity)), or become **Incorporeal** for 3 rounds. The target may repeat the save at the end of each of its turns, ending the restriction on a success.
...
- **Realmshift** [SR, WB, HW]: Cost: 5 SE. 10 min; 60-ft overlay Spectral/other plane (DR 3 Soul + Ritualism per min). See [Chapter 11, Section 11.1](./11-realms-terrain-arcane-power.md#111-realm-affinity) for rules on overlapping realms.
