...
- **Unique Trait**: *Wraith Phasing* (Bonus Action, a number of times per long rest equal to your Will: shift into a phased state until the end of your next turn. While phased, you are translucent, your Speed becomes 35 feet, you may move through terrain and barriers up to 1 foot thick *(Spectral only)* (see [Chapter 11, Section 11.1](./11-realms-terrain-arcane-power.md#111-realm-affinity)), your weapon and unarmed attacks deal Spectral damage instead of their normal type *(crosses realms)*, you gain Resistance to non-magical Physical damage, you are immune to non-magical **Grappled** and **Restrained** conditions, and you add +1 to your Will for the purpose of DV calculations. You must end your movement in an unoccupied space.)
...
- **Soul Bleed:** While in the Spectral Realm, Revenants suffer Soul Bleed at 1 HP per 3 rounds. See [Chapter 11, Section 11.5.1](./11-realms-terrain-arcane-power.md#1151-the-soul-economy). *(This is intentional design — Revenants are rejected by death but not native to the Spectral Realm. Unlike Wraiths, they cannot sustain extended presence beyond the veil without cost.)*
